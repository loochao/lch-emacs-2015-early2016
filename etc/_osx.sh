...
/usr/bin/defaults write com.apple.menuextra.clock 'DateFormat' -string 'EEE MMM d   h:mm a'
# Set highlight color to green
# defaults write NSGlobalDomain AppleHighlightColor -string "0.764700 0.976500 0.568600"

# Number of recent items: Applications/Documents/Servers: None
...
# Position on screen: left, right and bottom
...
/usr/bin/defaults write com.apple.iTunes 'allow-half-stars' -bool false
